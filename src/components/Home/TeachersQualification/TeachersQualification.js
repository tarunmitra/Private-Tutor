...
import "./TeachersQualification.css";
...
const TeachersQualification = () => {
  ...
  return (
    <section className='TeachersQualification-section pt-5'>
      <h3 className='text-center our-works mb-5'>
        Some teachers <span>Qualification</span>
      </h3>
...
export default TeachersQualification;
